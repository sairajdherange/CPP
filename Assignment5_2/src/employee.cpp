...
employee::employee(const char* name,const char* addr,int birth_day,int birth_month,int birth_year,int id,float sal,const char* dept,int joining_day, int joining_month, int joining_year)
:person(name , addr , birth_day , birth_month , birth_year)
{
	this->id = id;
